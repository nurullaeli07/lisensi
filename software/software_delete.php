...
<!---=================================================================================================================--->
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-trash"></i><strong> Hapus Data Software</strong></h3>
                <ol class="breadcrumb">
                    <li class="active">
                        <i class="fa fa-home"></i> 
						<a href="../config/index.php" title="Kembali ke Beranda">Beranda</a> &raquo; 
						<a href="../software/software.php" title="Lihat Data nama_software">Data Software</a> &raquo; Hapus Data Software
                    </li>
                </ol>
            </div>
        </div>
		...
		<div class="row"> 
			<div class="col-lg-12">
                <div class="panel panel-info">
					<div class="panel-heading"><i class="fa fa-trash"></i>  Data Software</div>
...
<!---=================================================================================================================--->
						<form id="update"  method="POST" class="form-horizontal">
							...
							<!-------------------------------------------------------->
							<div class="form-group">
								<label class="col-sm-5 control-label">Software</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="nama_software" value="<?php echo $data['nama_software']?>" readonly>
								</div>
							</div>
							<!-------------------------------------------------------->
							<div class="form-group">
							...
							<br>
								...
								<div class="form-group">
									<label class="col-sm-5 control-label">&nbsp;</label>
										...
										<button type="submit" name="update" class="btn btn-danger btn-md" title="Update Data Software">
										<span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Ya</button>
										<!-- Button untuk kembali ke halaman sebelumnya -->
										<a href="../nama_software/nama_software.php" class="btn btn-md btn-default" title="Kembali">
...
$res2 = $mysqli->query("delete from t_software where id='$id'");	
						  
if ($res1 && $res2)  {
	echo '<script language="javascript">alert("Data Berhasil Di Hapus")</script>';
	echo '<script language="javascript">window.location = "../software/software.php"</script>';
	}else{
	}
	echo '<script language="javascript">alert("Data Gagal Di Hapus")</script>';
	echo '<script language="javascript">window.location = "../software/software_delete.php"</script>';
}
?>
<!---=====================================================================================================================--->
